...
func (r ApiHealthHealthRequest) Execute() (bool, *http.Response, error) {
	return r.ApiService.HealthHealthExecute(r)
}

/*
HealthHealth health health
...
//  @return bool
func (a *HealthApiService) HealthHealthExecute(r ApiHealthHealthRequest) (bool, *http.Response, error) {
	var (
