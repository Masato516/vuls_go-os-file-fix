...
// ServerUpdateServerResponseBody struct for ServerUpdateServerResponseBody
...
func NewServerUpdateServerResponseBody(createdAt string, hostUuid string, id int64, needKernelRestart bool, osFamily string, osVersion string, platformInstanceId string, platformName string, serverIpv4 string, serverName string, serverUuid string, serverroleId int64, serverroleName string, updatedAt string) *ServerUpdateServerResponseBody {
	this := ServerUpdateServerResponseBody{}
...
func (o ServerUpdateServerResponseBody) MarshalJSON() ([]byte, error) {
...
type NullableServerUpdateServerResponseBody struct {
	value *ServerUpdateServerResponseBody
	isSet bool
}

func (v NullableServerUpdateServerResponseBody) Get() *ServerUpdateServerResponseBody {
	return v.value
}

func (v *NullableServerUpdateServerResponseBody) Set(val *ServerUpdateServerResponseBody) {
	v.value = val
	v.isSet = true
}

func (v NullableServerUpdateServerResponseBody) IsSet() bool {
	return v.isSet
}

func (v *NullableServerUpdateServerResponseBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableServerUpdateServerResponseBody(val *ServerUpdateServerResponseBody) *NullableServerUpdateServerResponseBody {
	return &NullableServerUpdateServerResponseBody{value: val, isSet: true}
}

func (v NullableServerUpdateServerResponseBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableServerUpdateServerResponseBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
