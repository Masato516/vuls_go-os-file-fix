...
func NewTaskAddTaskCommentResponseBody(createdAt time.Time, cveID string, id int64, ignore bool, priority string, roleID int64, roleName string, server ServerChildResponseBody, serverID int64, status string, updatedAt time.Time) *TaskAddTaskCommentResponseBody {
	this := TaskAddTaskCommentResponseBody{}
...
func (o TaskAddTaskCommentResponseBody) MarshalJSON() ([]byte, error) {
...
type NullableTaskAddTaskCommentResponseBody struct {
	value *TaskAddTaskCommentResponseBody
	isSet bool
}

func (v NullableTaskAddTaskCommentResponseBody) Get() *TaskAddTaskCommentResponseBody {
	return v.value
}

func (v *NullableTaskAddTaskCommentResponseBody) Set(val *TaskAddTaskCommentResponseBody) {
	v.value = val
	v.isSet = true
}

func (v NullableTaskAddTaskCommentResponseBody) IsSet() bool {
	return v.isSet
}

func (v *NullableTaskAddTaskCommentResponseBody) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableTaskAddTaskCommentResponseBody(val *TaskAddTaskCommentResponseBody) *NullableTaskAddTaskCommentResponseBody {
	return &NullableTaskAddTaskCommentResponseBody{value: val, isSet: true}
}

func (v NullableTaskAddTaskCommentResponseBody) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableTaskAddTaskCommentResponseBody) UnmarshalJSON(src []byte) error {
	v.isSet = true
